      ...
      <div className="mb-2">
        ...
        {adressList.map((feature: any) => (
          <button
            ...
            className="flex w-full items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-[#262626] text-gray-700 dark:text-white transition-colors cursor-pointer text-left"
          >
            <MapPin className="text-gray-300 dark:text-white shrink-0" size={16} />
