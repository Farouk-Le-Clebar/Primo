      ...
      <Table className="mt-4">
        <TableHead>
          <TableRow className="border-b border-gray-200 dark:border-white/5">
            <TableHeaderCell className="text-gray-500 dark:text-gray-400">
              Nom complet
            </TableHeaderCell>
            <TableHeaderCell className="text-gray-500 dark:text-gray-400">
              Email
            ...
            <TableHeaderCell className="text-right text-gray-500 dark:text-gray-400">
              Actions
            </TableHeaderCell>
          </TableRow>
        </TableHead>
            ...
            >
              <TableCell className="font-medium text-gray-900 dark:text-gray-200">
                <div className="flex items-center gap-3">
                  <Avatar profilePicture={user.profilePicture} size="w-9 h-9" />
                  <Link
