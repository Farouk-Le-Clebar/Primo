...
export function BuildingThumbnail({ feature, colorClasses }: { feature: any, colorClasses: any }) {  const geoData = useMemo(() => {
  ...
  if (!geoData) return <div className="w-full h-full bg-gray-50 dark:bg-[#232323] flex items-center justify-center text-[10px] text-gray-500 dark:text-gray-400">N/A</div>;
