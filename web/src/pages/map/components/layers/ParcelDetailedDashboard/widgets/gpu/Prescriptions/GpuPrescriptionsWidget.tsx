        ...
        <div className="overflow-hidden">
          {!isPending && isEmpty ? (
            <div className="py-4 text-sm text-[#878D96] text-center bg-gray-50 rounded-lg border border-gray-100 mt-2">
               Aucune servitude spécifique détectée sur cette parcelle.
            </div>
          ) : (
                  ...
                  <div key={index} className="flex flex-col bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div className="flex flex-col border-t border-[#F0F0F0]">
                      ...
                      <InfoRow 
                        ...
                        value={<span className="capitalize">{presc._kind}</span>} 
                      />
                      <InfoRow 
                        label="Référence (Code)" 
                        value={<span className="font-mono bg-gray-50 px-1.5 py-0.5 rounded border border-gray-100">{props.typepsc?.split('_')[0] || "AUTO"}</span>} 
                        isLast={true}
                      />
                    </div>
                  </div>
