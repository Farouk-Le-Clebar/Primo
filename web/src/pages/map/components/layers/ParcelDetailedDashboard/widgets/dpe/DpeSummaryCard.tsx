...
export default function DpeSummaryCard({ dpeList }: { dpeList: any[] }) {
  ...
  return (
    <Card className="border-gray-200 bg-white dark:border-[#232323] dark:bg-[#111111] ring-0 shadow-sm p-6 h-full flex flex-col font-inter">
      ...
      <div className="grid grid-cols-3 gap-2 mb-8 border-t border-b border-gray-200 dark:border-[#232323] pt-4 pb-4">
        <div className="bg-[#F8F9FB] dark:bg-[#232323] rounded-lg p-3 text-center border border-gray-200 dark:border-[#232323] flex flex-col justify-center items-center">
          <span className="block text-sm font-bold text-gray-900 dark:text-white">{stats.avgConso} <span className="text-[10px] font-normal">kWh/m²</span></span>
          <span className="block text-[10px] text-gray-500 dark:text-gray-400 uppercase mt-0.5">Conso. Moy.</span>
        </div>
        <div className="bg-[#F8F9FB] dark:bg-[#232323] rounded-lg p-3 text-center border border-gray-200 dark:border-[#232323] flex flex-col justify-center items-center">
          <span className="block text-sm font-bold text-gray-900 dark:text-white">{formatEuro(stats.avgCost)}</span>
          <span className="block text-[10px] text-gray-500 dark:text-gray-400 uppercase mt-0.5">Coût Moy./an</span>
        </div>
        <div className="bg-[#F8F9FB] dark:bg-[#232323] rounded-lg p-3 text-center border border-gray-200 dark:border-[#232323] flex flex-col justify-center items-center">
          <span className="block text-sm font-bold text-gray-900 dark:text-white">{stats.avgSurface} <span className="text-[10px] font-normal">m²</span></span>
          <span className="block text-[10px] text-gray-500 dark:text-gray-400 uppercase mt-0.5">Surface Moy.</span>
        </div>
      </div>
      ...
      <div className="pt-4 mb-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <span className="text-sm font-bold text-gray-900 dark:text-white">{stats.count} DPE</span>
        </div>
