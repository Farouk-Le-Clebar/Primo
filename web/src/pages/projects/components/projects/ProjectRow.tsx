...
const ProjectRow: React.FC<ProjectRowProps> = ({
    ...
    return (
        <tr onClick={() => onProjectClick(project)} className="cursor-pointer">
            ...
            {/* Parameters column */}
            <td className="px-6 py-4">
                <span className="inline-flex whitespace-nowrap items-center gap-1.5 px-3 py-1 bg-green-100 text-green-600 rounded-md text-xs">
                    <svg
            ...
            {/* Parcels column */}
            <td className="px-6 py-4">
                <span className="inline-flex whitespace-nowrap items-center gap-1.5 px-3 py-1 bg-purple-100 text-purple-600 rounded-md text-xs">
                    <svg
                        className="w-3.5 h-3.5"
                        fill="none"
                        stroke="currentColor"
            ...
            {/* Members column */}
            <td className="px-6 py-4">
                <span className="inline-flex whitespace-nowrap items-center gap-1.5 px-3 py-1 bg-blue-100 text-blue-600 rounded-md text-xs">
                    <svg
                        className="w-3.5 h-3.5"
                        fill="none"
                        stroke="currentColor"
