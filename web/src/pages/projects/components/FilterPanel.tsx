...
/**
 * Options de période pour le filtre de date
 */
const TIME_RANGES = [
...
/**
 * Composant du panneau de filtres
 */
const FilterPanel: React.FC<FilterPanelProps> = ({
  ...
  return (
    <div className="absolute right-0 top-12 bg-white rounded-lg shadow-lg border border-gray-200 p-4 w-80 z-10">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) => onFiltersChange({ ...filters, parametersMin: e.target.value })}
            ...
            <input
              ...
              onChange={(e) => onFiltersChange({ ...filters, parametersMax: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              min="0"
            />
          </div>
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) => onFiltersChange({ ...filters, parcelsMin: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              min="0"
            />
            <input
              ...
              onChange={(e) => onFiltersChange({ ...filters, parcelsMax: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              min="0"
            />
          </div>
