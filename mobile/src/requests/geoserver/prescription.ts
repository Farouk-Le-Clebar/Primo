...
export const getPrescriptionsSurf = (geometry: any, dept: string) =>
  fetchLayer(geometry, dept, "wfs_du:prescription_surf", "prescription_surf");

export const getPrescriptionsLin = (geometry: any, dept: string) =>
  fetchLayer(geometry, dept, "wfs_du:prescription_lin", "prescription_lin");

export const getPrescriptionsPct = (geometry: any, dept: string) =>
  fetchLayer(geometry, dept, "wfs_du:prescription_pct", "prescription_pct");
