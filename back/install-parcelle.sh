...
DATA_DIR="./data/parcelles"
EXTRACT_DIR="./data/parcelles_extracted"
...
for dept in "${DEPARTEMENTS[@]}"; do
    ...
    FILENAME="cadastre-${dept}-parcelles-shp.zip"
    ZIP_PATH="${DATA_DIR}/${FILENAME}"
    DEPT_EXTRACT_DIR="${EXTRACT_DIR}/${dept}"
    TABLE_NAME="parcelles_${dept}"
